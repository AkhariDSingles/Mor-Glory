...
#load images
back_img = pygame.image.load('mor assets/bg.png')
back_img = pygame.transform.scale(back_img, (screen_width, screen_height - margin))
...
exit_img = pygame.image.load('mor assets/exitd.png')
...
blob_img = pygame.image.load('mor assets/opps/tile010.png')
lava_img = pygame.image.load('mor assets/opps/lava1.png')
coin_img = pygame.image.load('mor assets/coins/coin.png')
save_img = pygame.image.load('mor assets/save_btn.png')
load_img = pygame.image.load('mor assets/load_btn.png')
...
font = pygame.font.SysFont('chicago', 24)
